						...
						function($filter, $document, $compile, $parse) {
							...
							return {
								...
								template : function(element, attrs) {
									...
									var template = '<div class="multiselect-parent btn-group dropdown-multiselect" style="float:left">';
									template += '<button type="button" class="dropdown-toggle" style="float:left;width: auto" ng-class="settings.buttonClasses" ng-click="toggleDropdown()">{{getButtonText()}}&nbsp;<span class="caret"></span></button>';
									...
									$scope.getButtonText = function() {
										if ($scope.settings.dynamicTitle
											...
											if ($scope.settings.smartButtonMaxItems > 0) {
												...
												if ($scope.selectedModel.length > 6) {
													itemsText = itemsText
															.slice(
																	0,
																	6);
